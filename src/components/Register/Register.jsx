...
import {Autocomplete, Box, Checkbox, Container, CssBaseline, Grid, Link, Stack, Typography} from "@mui/material";
import {
    BoxStyle,
    ContainerStyle,
    IconCircle,
                ...
                <Grid container sx={{height: "100%"}}>
                    <Grid item lg={6} xs={12} container direction={"column"} alignItems={"center"}
                        ...
                        <Stack spacing={2}>
                            ...
                            <Typography variant={"h1"} component={"div"} sx={Title}>Create an account</Typography>
                            <Typography variant={"h1"} component={"div"} sx={NewUserStyle}>already a user?
                                <Link
                                    onClick={() => {
                                        router('/Account')
                                    }}
                            ...
                            <Formik initialValues={{
                                ...
                                {(formikProps) => (<Form>
                                    <Grid container alignItems={"start"} spacing={2}>
                                        ...
                                        <Grid item xs={12}>
                                            <InputField label={"CashFlash Name"} type={"text"} name={"cashflashName"}/>
                                        </Grid>
                                        <Grid item xs={12}>
                                        ...
                                        <Grid item xs={12}>
                                            <Typography variant={"h1"} component={"div"} sx={Info}>You are requerid to
                                                pass KYC/AML</Typography>
                                        </Grid>
                                        <Grid item xs={12}>
